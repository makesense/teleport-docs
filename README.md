...
Access your wallet via MyEtherWallet. Select method (i.e. Ledger, Metamask, etc) and then make your window really wide so you can see the menu on the left, click the "CONTRACT" menu listed as the 5th item on the list below "DASHBOARD."
